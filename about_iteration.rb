...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #Explanation - http://blog.jayfields.com/2008/03/ruby-inject.html
  end
...
#Gyan - 
  #each -> operates on each element of the array.
  #collect and map are the same - both of them tranform the array elements.
  #select and find_all -> cherry pick the array elements.
  #find -> locates the first element in the array mathcing the criteria.
