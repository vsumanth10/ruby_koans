...
#GYAN - 
  #methods can be called directly or by passing as params to send methods
  # Ex : obj.method or obj.send("method") or obj.send(:method)
  #to be on the safer side, always use __send__

  #method_missing -> lets you to handle cases where the methods are missing.
